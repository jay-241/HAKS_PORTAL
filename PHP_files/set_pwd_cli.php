...
{
	header("location:update_product.php?error=Mind Your Business. Do not do this :)"); 
}
else{
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Enter OTP To Proceed<br>Enter OTP which is sent on below email.</h3>
						<form class="row login_form" action="verify_otp_ser.php" method="post" id="contactForm" >
							<div class="col-md-12 form-group">
								<?php if(isset($_GET['error'])){echo "<font color='red'>".$_GET['error']."</font>"; } ?>
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="uname" placeholder="Username" value=" <?php echo "$uname"; ?> "  disabled>
							</div>
							<div class="col-md-12 form-group">
								
								<input type="text" class="form-control" id="name" name="uemail" placeholder="UserEmail"  value=" <?php echo "$uemail"; ?> " disabled>
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="uotp" placeholder="OTP" required="required">
							</div>
							<!-- <div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="btn submit_btn" name="submit">Verify Otp</button>
