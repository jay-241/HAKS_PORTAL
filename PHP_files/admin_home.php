				...
				<div class="row">
					<nav class="cat_page mx-auto" aria-label="Page navigation example">
						<ul class="pagination">
								...
								<a class="page-link" href="admin_home.php?pno=<?php echo 1; ?>">
									<i class="fa fa-home"  aria-hidden="true" style="font-size:28px;margin-top:4px" label="Home"></i>
								</a>
							</li></li><li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno-8; ?>">
							...
							<li class="page-item active">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno; ?>"><?php echo $pno; ?></a>
							</li><?php } ?>
							<li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno+1; ?>"><?php echo $pno+1; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno+2; ?>"><?php echo $pno+2; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno+3; ?>"><?php echo $pno+3; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno+4; ?>"><?php echo $pno+4; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno+5; ?>"><?php echo $pno+5; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno+6; ?>"><?php echo $pno+6; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno+7; ?>"><?php echo $pno+7; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno+8; ?>"><?php echo $pno+8; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="admin_home.php?pno=<?php echo $pno+1; ?>">
				...
				<div class="row">
					...
					if(isset($_GET['pno']))
						...
						if(mysqli_num_rows($cmd)>0){
							...
							?>
								<!-- <a href="single-product.php?f=admin_home&P_id=<?php //echo $row[0]; ?>"> -->
								...
								$i=1; } ?>"> 
									<div class="f_p_item">
										...
										<a href="#">
											<h4><?php echo "Id:-".$row[0]."&nbsp;&nbsp;"; /*P_company*/ ?></h4>
										</a><a href="#">
						...
						if($k>0){
							...
							?>
								<!-- <a href="#"> --><div class="col col<?php echo "$i"; if($i<=9){ $i++; }else{
								$i=1; } ?>"> 
									<div class="f_p_item">
										<div class="f_p_img">
											<img src="<?php echo "$row[7]"; /*P_link */?>" alt="" height="200px" width="200px">
