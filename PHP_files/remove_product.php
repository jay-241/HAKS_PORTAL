			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="remove_product_ser.php" method="post" id="contactForm" >
							...
							<div class="col-md-12 form-group">
								<button type="submit" name="submit" value="submit" class="btn submit_btn">Remove Product</button>
