			 ...
			 <div class="container"> 
				<div class="banner_content text-center">
					...
					<div class="page_link">
						...
						<a href="upload_product.php">Add Product</a>
					</div>
				</div>
			 </div> 
		</div>
				...
				<!--<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<a class="main_btn" href="#">Add A New Product</a>
						</div>
					</div>
				</div>-->
				<div class="col-lg-6">
					<div class="login_form_inner reg_form">
						...
						<form class="row login_form" action="upload.php" method="post" id="contactForm" enctype="multipart/form-data">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="P_id" placeholder="Product Id" required="required">
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="P_name" placeholder="Product Name" required="required">
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="P_category" placeholder="Product Category" required="required">
							</div>
							<div class="col-md-12 form-group">
								<input type="number" class="form-control" id="name" name="P_availability" placeholder="Available Product" min="01" max="101" required="required">
							</div>
							<div class="col-md-12 form-group">
								<input type="Number" class="form-control" id="name" name="P_price" placeholder="Product Price Per Unit" min="01" required="required">
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="P_company" placeholder="Product Company" required="required">
							</div>
							<pre> &nbsp;&nbsp;&nbsp;</pre><h6><font color="red">Product Description:-</font></h6><div class="col-md-12 form-group">
								<textarea  class="form-control" id="name" name="P_expirydate" placeholder="Product Description" required="required"rows="3" cols="50"></textarea>
							</div>
							...
							<div class="col-md-12 form-group">
								<input type="Number" class="form-control" id="name" name="P_oprice" placeholder="Offer Price" required="required" value="0">
							</div>
							<!-- <div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="btn submit_btn" name="submit">Add Product</button>
							</div>
