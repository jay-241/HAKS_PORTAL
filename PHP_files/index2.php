...
if(isset($_SESSION['cid'])){session_destroy();}
if(isset($_SESSION['aid'])){session_destroy();}
						...
						<div class="row w-100">
							<div class="col-lg-7 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									...
									<?php $p="https://securegw.paytm.in/merchant-status/getTxnStatus"; ?>
									<!-- <li class="nav-item submenu dropdown">
			...
			<?php 
				...
				<div class="row">
					<nav class="cat_page mx-auto" aria-label="Page navigation example">
						<ul class="pagination">
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo 1; ?>">
									<i class="fa fa-home" style="font-size:28px;margin-top:4px" aria-hidden="true"></i>
								</a>
							</li><li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno-8; ?>">
									<i class="fa fa-angle-double-left"  style="font-size:28px;margin-top:4px" aria-hidden="true"></i>
								</a>
							</li><li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno-1; ?>">
									<i class="fa fa-chevron-left" aria-hidden="true"></i>
								</a>
							</li>
							<?php if($pno!=0){?>
							<li class="page-item active">
								<a class="page-link" href="index2.php?pno=<?php echo $pno; ?>"><?php echo $pno; ?></a>
							</li><?php } ?>
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno+1; ?>"><?php echo $pno+1; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno+2; ?>"><?php echo $pno+2; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno+3; ?>"><?php echo $pno+3; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno+4; ?>"><?php echo $pno+4; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno+5; ?>"><?php echo $pno+5; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno+6; ?>"><?php echo $pno+6; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno+7; ?>"><?php echo $pno+7; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno+8; ?>"><?php echo $pno+8; ?></a>
							</li>
							<li class="page-item">
								<a class="page-link" href="index2.php?pno=<?php echo $pno+1; ?>">
								...
								<a class="page-link" href="index2.php?pno=<?php echo $pno+8; ?>">
									<i class="fa fa-angle-double-right" style="font-size:28px;margin-top:4px" aria-hidden="true"></i>
								</a>
							</li>
						</ul>
					</nav>
