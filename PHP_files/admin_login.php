			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="insert_admin_login.php" method="post" id="contactForm" >
							
							<?php if(isset($_GET['msg'])){ echo "<div class=\"col-md-12 form-group\"><font color='red'>".$_GET['msg']."</font></div>"; } ?>
								<?php if(isset($_SESSION['error2'])){ echo "<div class=\"col-md-12 form-group\"><font color='red'>Invalid Admin Id and Password</font></div>"; } ?>
							
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="aduname" placeholder="Admin Id">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" minlength="8" max="15" class="form-control" id="name" name="adpass" placeholder="Password" required="required">
							</div>
							<!--<div class="col-md-12 form-group">
