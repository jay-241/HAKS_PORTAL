...
{
	header("location:Forgot_Password.php?error=Mind Your Business. Do not do this :)"); 
}
else{
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Enter New Password To Proceed</h3>
						<form class="row login_form" action="verify_pwd_ser.php" method="post" id="contactForm" >
							<div class="col-md-12 form-group">
								<?php if(isset($_GET['error'])){echo "<font color='red'>".$_GET['error']."</font>"; } ?>
							</div>
							<div class="col-md-12 form-group">
								<input type="password" minlength="8" class="form-control" id="name" name="unpwd" placeholder="New Password">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" minlength="8" class="form-control" id="name" name="urnpwd" placeholder="Re-enter new Password">
							</div>
							<!-- <div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="btn submit_btn" name="submit">Set New Password</button>
