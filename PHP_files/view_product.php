			...
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
						...
						<a href="view_product.php">Search Product</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="view_product_ser.php" method="post" id="contactForm" >
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="btn submit_btn">Search Product</button>
