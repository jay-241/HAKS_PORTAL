			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Enter User Id To Proceed</h3>
						<?php if(isset($_GET['error'])){echo "<font color='red'>".$_GET['error']."</font>"; } ?>
						<form class="row login_form" action="send-text-email.php" method="post" id="contactForm" >
							<div class="col-md-12 form-group">
								<?php if(isset($_SESSION['error3'])){ echo "<font color='red'>Invalid Username and User Email</font>"; } ?>
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="uname" placeholder="UserID" required="required">
							</div>
							<!-- <div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="btn submit_btn">Get Otp</button>
