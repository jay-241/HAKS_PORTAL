<?php
session_start();
if (isset($_GET['P_id'])){} else{ header("location:index2.php"); }
	...
	if($row = mysqli_fetch_array($result))
    {
		...
		header("location:update_product.php?error=Product Not Found");
	}
?>
			 ...
			 <div class="container"> 
				<div class="banner_content text-center">
					...
					<div class="page_link">
						...
						<a href="admin_account.php">My Account</a>
					</div>
				</div>
			 </div> 
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner reg_form">
						...
						<form class="row login_form" action="Update_product_ser.php" method="post" id="contactForm" enctype="multipart/form-data">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="P_id" placeholder="Product Id" required="required" disabled="disabled" value=<?php echo $_SESSION['P_id']; ?>>
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="P_name" placeholder="Product Name" required="required" value=<?php echo $P_name; ?>>
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="P_category" placeholder="Product Category" required="required" value=<?php echo $P_category; ?>>
							</div>
							<div class="col-md-12 form-group">
								<input type="number" class="form-control" id="name" name="P_availability" placeholder="Available Product" min="01" max="101" required="required" value=<?php echo $P_availability; ?>>
							</div>
							<div class="col-md-12 form-group">
								<input type="Number" class="form-control" id="name" name="P_price" placeholder="Product Price Per Unit" min="01" required="required" value=<?php echo $P_price; ?>>
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="P_company" placeholder="Product Company" required="required" value=<?php echo $P_company; ?>>
							</div>
							<pre> &nbsp;&nbsp;&nbsp;</pre><h6><font color="red">Product Description:-</font></h6><div class="col-md-12 form-group">
								<textarea class="form-control" id="name" name="P_expirydate" placeholder="Product Description" required="required" rows="3" cols="50"><?php echo $P_expirydate; ?></textarea>
							</div>
							...
							<select name="P_isOffer">
							<?php if(!$P_isOffer){?>
								<option value="YES">Yes</option> 
							<option value="NO" selected="selected">No</option><?php } else {
							...
							<div class="col-md-12 form-group">
								<input type="Number" class="form-control" id="name" name="P_oprice" placeholder="Offer Price" required="required" value=<?php echo $P_oprice; ?>>
							</div>
							<!-- <div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="btn submit_btn" name="submit">Update Product</button>
							</div>
						</form>
					</div>
				</div>
